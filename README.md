...
| /api/v1/apiServices/updateNotice/ | notice, title, category, time, state, offer, place, colors, description, locations, urgency, visibility, quantity | PUT | success, msg, err | Edicion publicacion de servicio o producto *Un campo a la vez* |
